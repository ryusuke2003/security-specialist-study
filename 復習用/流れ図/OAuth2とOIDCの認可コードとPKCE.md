...
![認可コードはブラウザ経由。トークン交換はサーバー間。](画像/OAuth2%E3%81%A8OIDC%E3%81%AE%E8%AA%8D%E5%8F%AF%E3%82%B3%E3%83%BC%E3%83%89%E3%81%A8PKCE.svg)

<details>
<summary>図の内容を文字で読む</summary>

<!-- overview:start -->
要点: 認可コードはブラウザ経由。トークン交換はサーバー間。

補足: サーバーサイドWebアプリの例。PKCEは認可サーバ、IDトークンはWebアプリが検証。
